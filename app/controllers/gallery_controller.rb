class GalleryController < ApplicationController
  ...
  def search
    ...
    @search_results= Store.find_by_sql ["Select * from stores WHERE name like ? or brand like ? or color like ? or description like ?",keyword,keyword,keyword,keyword]


    # select * from stores where name like ? or brand like ? or type like ? or description like ? or color like ? 
  end
end
